...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_SU23')
BEGIN
	ALTER DATABASE [PE_DBI202_SU23] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_SU23] SET ONLINE;
	DROP DATABASE [PE_DBI202_SU23];
END

GO

CREATE DATABASE [PE_DBI202_SU23]
GO
